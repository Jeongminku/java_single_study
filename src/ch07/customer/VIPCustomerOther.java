...
public class VIPCustomerOther extends Customer {
	...
	public VIPCustomerOther(int customerID, String customerName, int agentID) {
		...
		super.bonusRatio = 0.03;//Customer.java > SILVER등급의 bonusRatio 가 없음이었으나 VIP부터는 0.05가 적용됨. 초기값을 0.05로 수정함.
		this.saleRatio = 0.2;//Customer.java > SILVER등급의 할인율은 없음 이지만, VIP의 할인율은 0.5이다.
